...
const TradeHistory = () => {
  ...
  const fetchTrades = async () => {
    try {
      ...
      setError(err.error || 'Failed to fetch trade history');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">View your complete trading activity</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {trades.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-gray-500 text-lg mb-4">You haven't made any trades yet</div>
              <p className="text-gray-600">Start trading to see your history here</p>
            </div>
          ) : (
            <>
                    ...
                    <div>
                      <p className="text-sm text-gray-700">
                        ...
                        <span className="font-medium">
                          {Math.min(indexOfLastTrade, trades.length)}
                        </span>{' '}
